...
-   🟡 **Amarelo/laranja (`Skipped` / `FloodWait`):** o motor ignorou um elemento (por exemplo por ser anterior à *Data de Início*) ou o Telegram pediu uma pausa anti-spam, que o bot gere sozinho.
