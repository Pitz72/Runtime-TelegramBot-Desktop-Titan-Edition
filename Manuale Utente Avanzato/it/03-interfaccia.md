...
-   🟡 **Giallo/arancione (`Skipped` / `FloodWait`):** il motore ha ignorato un elemento (per esempio perché precedente alla *Data di Partenza*) oppure Telegram ha chiesto una pausa anti-spam, che il bot gestisce da solo.
