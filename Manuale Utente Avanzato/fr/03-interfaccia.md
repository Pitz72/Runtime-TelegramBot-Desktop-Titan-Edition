...
-   🟡 **Jaune/orange (`Skipped` / `FloodWait`) :** le moteur a ignoré un élément (par exemple parce qu'il est antérieur à la *Start Date*) ou Telegram a demandé une pause anti-spam, que le bot gère tout seul.
