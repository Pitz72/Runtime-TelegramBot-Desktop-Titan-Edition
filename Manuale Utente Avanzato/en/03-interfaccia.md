...
After the Setup Wizard, and on every later launch, you land on Titan's command console: a glassy-looking interface split down the middle (the 50/50 layout).
