...
-   🟡 **Amarillo/naranja (`Skipped` / `FloodWait`):** el motor ha ignorado un elemento (por ejemplo por ser anterior a la *Start Date*) o Telegram ha pedido una pausa anti-spam, que el bot gestiona solo.
