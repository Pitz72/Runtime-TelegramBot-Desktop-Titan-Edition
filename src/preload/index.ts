...
const api = {
    ...
    addFeed: (feed: { botId: number; name: string; url: string; type: string; keywordFilter?: string | null }) =>
        ipcRenderer.invoke('add-feed', feed),
    updateFeed: (feed: { id: number; name: string; url: string; type: string; keywordFilter?: string | null }) =>
