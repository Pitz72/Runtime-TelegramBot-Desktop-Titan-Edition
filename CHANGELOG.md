...
- [v1.10.11 (Corrente)](docs/changelogs/CHANGELOG_v1.10.11.md) — "CleanTube": rimosso locale forcing YouTube (gl/hl=en) che causava 0 item e session reset su diversi canali.
