...
- [v1.8.x (Corrente)](docs/changelogs/CHANGELOG_v1.8.1.md) — Versione attuale: v1.8.1. Fix tecnici P2: #16 lazy DB init con getDB(), #18 normalizzazione boolean SQLite, #20 backup condizionale pre-migrazione. v1.8.0: Sistema di Verifica Intelligente dei Template.
...
## Versione Attuale: v1.8.1

Per i dettagli dell'ultima versione, consulta [docs/changelogs/CHANGELOG_v1.8.1.md](docs/changelogs/CHANGELOG_v1.8.1.md).
