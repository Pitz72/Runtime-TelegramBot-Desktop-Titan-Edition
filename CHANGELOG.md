...
- [v1.8.x (Corrente)](docs/changelogs/CHANGELOG_v1.8.0.md) — Versione attuale: v1.8.0. Nuova funzionalità: Sistema di Verifica Intelligente dei Template — validatore HTML real-time integrato nel TemplateEditor con rilevamento di tag non supportati, tag non bilanciati, chip sconosciuti e chip pericolosi in href. Localizzazione completata per tutte e 9 le lingue.
...
Per i dettagli dell'ultima versione, consulta [docs/changelogs/CHANGELOG_v1.8.0.md](docs/changelogs/CHANGELOG_v1.8.0.md).
