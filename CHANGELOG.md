...
- [v1.8.x (Corrente)](docs/changelogs/CHANGELOG_v1.8.4.md) — Versione attuale: v1.8.4. F2 Retry Queue (max 3 tentativi, markProcessed su esaurimento). v1.8.3: #22/#23 logging strutturato, #24/#26 pulizia root. v1.8.2: rate-limiting/#19 cache YouTube. v1.8.1: #16/#18/#20. v1.8.0: Validatore Template.
...
## Versione Attuale: v1.8.4

Per i dettagli dell'ultima versione, consulta [docs/changelogs/CHANGELOG_v1.8.4.md](docs/changelogs/CHANGELOG_v1.8.4.md).
