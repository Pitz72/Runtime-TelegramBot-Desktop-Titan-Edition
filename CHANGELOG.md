...
- [v1.8.x (Corrente)](docs/changelogs/CHANGELOG_v1.8.5.md) — Versione attuale: v1.8.5. F3 Dashboard multi-bot: dot stato sidebar, toggle filtro log ALL/BOT, i18n 8 lingue. v1.8.4: F2 Retry Queue. v1.8.3: logging strutturato. v1.8.2: rate-limiting/cache YouTube. v1.8.1: fix DB/bool.
...
## Versione Attuale: v1.8.5

Per i dettagli dell'ultima versione, consulta [docs/changelogs/CHANGELOG_v1.8.5.md](docs/changelogs/CHANGELOG_v1.8.5.md).
