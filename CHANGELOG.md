...
- [v1.8.x (Corrente)](docs/changelogs/CHANGELOG_v1.8.7.md) — Versione attuale: v1.8.7. F4 Filtro Keyword per feed (include/exclude, case-insensitive, schema v8). v1.8.6: bug fix critico #27 anti-spam title_hash. v1.8.5: F3 Dashboard multi-bot. v1.8.4: F2 Retry Queue. v1.8.3: logging strutturato.
...
## Versione Attuale: v1.8.7

Per i dettagli dell'ultima versione, consulta [docs/changelogs/CHANGELOG_v1.8.7.md](docs/changelogs/CHANGELOG_v1.8.7.md).
